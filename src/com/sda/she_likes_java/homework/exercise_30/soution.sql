...
ALTER TABLE STUDENTS ADD COLUMN GRADE INT; -- adding new table, alter table+table_name+add column + collumn name+ type
SELECT * FROM STUDENTS ;

ALTER TABLE STUDENTS DROP COLUMN GRADE; -- removing column
ALTER TABLE STUDENTS ADD COLUMN GRADE INT NOT NULL  USING 5 ; --creating collumn gradee with all values set to 5